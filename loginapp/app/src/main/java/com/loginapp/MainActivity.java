...
public class MainActivity extends AppCompatActivity {
    ...
    public void myLogin()
    {
        ...
        {
            if(username.equals("Admin")&&password.equals("koushik123"))//if username and password matches the given credentials
            {
            ...
            {
                Info.setText("Invalid Login details");//displays when user enter invalid credentials
            }
        }
        else
        {
            Info.setText("username and password does not match");//displays when user clicks login button with blank fields
        }
    }
}
